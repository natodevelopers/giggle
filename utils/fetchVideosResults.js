const fetchVideosResults = (q, page, max = 60) => {
    ...
    return new Promise((resolve) => {
        fetch(`https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=50&q=${encodeURIComponent(q)}&type=video&order=viewCount&key=${process.env.YOUTUBE_API_KEY}&safeSearch=moderate`)
